...
assert.sameValue(function (a) {
  return arguments.length <= 1 ? 0 : arguments.length - 1;
...
assert.sameValue(function (a, b, c) {
  return arguments.length <= 3 ? 0 : arguments.length - 3;
}(1, 2, 3, 4, 5), 2, "`(function(a, b, c, ...args) { return args.length; })(1,2,3,4,5)` returns `2`");
assert.sameValue(function (a, b, c, d) {
  return arguments.length <= 4 ? 0 : arguments.length - 4;
}(1, 2, 3, 4, 5), 1, "`(function(a, b, c, d, ...args) { return args.length; })(1,2,3,4,5)` returns `1`");
assert.sameValue(function (a, b, c, d, e) {
  return arguments.length <= 5 ? 0 : arguments.length - 5;

...
assert(compareArray(c.child, [1, 2, 3]), "`compareArray(c.child, [1, 2, 3])` returns `true`");
assert(compareArray(c.base, [1, 2, 3]), "`compareArray(c.base, [1, 2, 3])` returns `true`");
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              assert.sameValue(_arguments.length, 4);
              assert.sameValue(_arguments[0], 42);
              assert.sameValue(_arguments[1], 1);
              assert.sameValue(_arguments[2], 2);
              assert.sameValue(_arguments[3], 3);
...
var ref = obj.method;
ref.apply(void 0, [42].concat([1], arr)).next().then(function () {

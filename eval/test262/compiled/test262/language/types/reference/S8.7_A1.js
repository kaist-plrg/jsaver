...
//
var obj = new Object(); // objRef now refers to the other object
//

var objRef = obj; // Modify a property in the original object

objRef.oneProperty = -1;
obj.oneProperty = true; // We now see that that change is represented in both variables

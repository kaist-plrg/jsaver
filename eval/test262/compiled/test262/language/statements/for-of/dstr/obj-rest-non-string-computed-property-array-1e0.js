...
for (var _i = 0, _arr = [(_ref2 = {}, _defineProperty(_ref2, a, [1e0]), _defineProperty(_ref2, "bar", 2), _ref2)]; _i < _arr.length; _i++) {
  var _ref2;

  var _ref = _arr[_i];
  var _ref3 = _ref;
  b = _ref3[a];
  rest = _objectWithoutProperties(_ref3, [a].map(_toPropertyKey));
  _ref3;

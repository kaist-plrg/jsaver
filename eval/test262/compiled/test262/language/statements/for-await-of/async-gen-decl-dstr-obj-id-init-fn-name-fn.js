...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$xFnexp, _step$value$fnexp;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$xFnexp = _step$value.xFnexp;
            xFnexp = _step$value$xFnexp === void 0 ? function x() {} : _step$value$xFnexp;
            _step$value$fnexp = _step$value.fnexp;
            fnexp = _step$value$fnexp === void 0 ? function () {} : _step$value$fnexp;

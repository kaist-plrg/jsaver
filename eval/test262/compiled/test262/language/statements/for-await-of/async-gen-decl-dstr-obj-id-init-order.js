...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$a, _step$value$b;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$a = _step$value.a;
            a = _step$value$a === void 0 ? x += 1 : _step$value$a;
            _step$value$b = _step$value.b;
            b = _step$value$b === void 0 ? x *= 2 : _step$value$b;

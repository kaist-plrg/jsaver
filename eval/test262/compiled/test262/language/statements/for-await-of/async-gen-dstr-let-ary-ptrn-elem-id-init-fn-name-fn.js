...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$, _fn2, _step$value$2, xFn;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value = _slicedToArray(_step.value, 2), _step$value$ = _step$value[0], _fn2 = _step$value$ === void 0 ? function () {} : _step$value$, _step$value$2 = _step$value[1], xFn = _step$value$2 === void 0 ? function x() {} : _step$value$2;

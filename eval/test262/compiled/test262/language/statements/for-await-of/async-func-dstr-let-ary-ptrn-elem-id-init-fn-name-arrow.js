...
function _fn() {
  _fn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$, arrow;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value = _slicedToArray(_step.value, 1), _step$value$ = _step$value[0], arrow = _step$value$ === void 0 ? function () {
              _newArrowCheck(this, _this2);
            }.bind(this) : _step$value$;

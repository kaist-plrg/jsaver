...
function _fn() {
  _fn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value$w, _step$value$w2, x, y, z;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$w = _step$value$w === void 0 ? [4, 5, 6] : _step$value$w;
            _step$value$w2 = _slicedToArray(_step$value$w, 3), x = _step$value$w2[0], y = _step$value$w2[1], z = _step$value$w2[2];

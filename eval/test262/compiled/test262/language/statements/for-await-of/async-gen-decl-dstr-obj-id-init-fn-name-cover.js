...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$xCover, _step$value$cover;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$xCover = _step$value.xCover;
            xCover = _step$value$xCover === void 0 ? (0, function () {}) : _step$value$xCover;
            _step$value$cover = _step$value.cover;
            cover = _step$value$cover === void 0 ? function () {} : _step$value$cover;

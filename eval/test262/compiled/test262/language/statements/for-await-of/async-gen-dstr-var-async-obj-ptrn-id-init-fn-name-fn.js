...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$fn, fn, _step$value$xFn, xFn;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _step$value = _step.value, _step$value$fn = _step$value.fn, fn = _step$value$fn === void 0 ? function () {} : _step$value$fn, _step$value$xFn = _step$value.xFn, xFn = _step$value$xFn === void 0 ? function x() {} : _step$value$xFn;

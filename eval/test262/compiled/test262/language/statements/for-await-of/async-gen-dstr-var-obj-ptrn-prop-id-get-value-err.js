...
function _gen() {
  _gen = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value$poisoned, x;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _iterator = _asyncIterator([poisonedProperty]);
          ...
          case 6:
            ...
            _step$value$poisoned = _step.value.poisoned, x = _step$value$poisoned === void 0 ? ++initEvalCount : _step$value$poisoned;

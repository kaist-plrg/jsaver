...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$s, t, _step$value$u, v, _step$value$w, x, _step$value$y, z;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value = _step.value, _step$value$s = _step$value.s, t = _step$value$s === void 0 ? counter() : _step$value$s, _step$value$u = _step$value.u, v = _step$value$u === void 0 ? counter() : _step$value$u, _step$value$w = _step$value.w, x = _step$value$w === void 0 ? counter() : _step$value$w, _step$value$y = _step$value.y, z = _step$value$y === void 0 ? counter() : _step$value$y;

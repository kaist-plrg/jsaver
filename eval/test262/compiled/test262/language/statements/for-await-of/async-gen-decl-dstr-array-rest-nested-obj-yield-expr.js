      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$slice$x = _step$value.slice(0).x;

            if (!(_step$value$slice$x === void 0)) {
              _context.next = 15;
              break;
            }
          ...
          case 15:
            _context.t0 = _step$value$slice$x;
...
var iter = fn();
iter.next().then(function (iterationResult) {
  var _this2 = this;
  ...
  iter.next(4).then(function (iterationResult) {

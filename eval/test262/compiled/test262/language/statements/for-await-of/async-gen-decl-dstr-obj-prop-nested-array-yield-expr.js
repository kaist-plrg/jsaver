...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value$x, _step$value$x$;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$x = _slicedToArray(_step.value.x, 1);
            _step$value$x$ = _step$value$x[0];
...
iter.next().then(function (result) {
  ...
  iter.next(24601).then(function (result) {

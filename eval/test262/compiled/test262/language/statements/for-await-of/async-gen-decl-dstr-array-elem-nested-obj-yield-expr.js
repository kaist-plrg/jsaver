...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$0$x;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _step$value$0$x = _step$value[0].x;

            if (!(_step$value$0$x === void 0)) {
              _context.next = 15;
              break;
            }
...
iter.next().then(function (result) {
  ...
  iter.next(4).then(function (result) {

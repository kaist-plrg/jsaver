  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.delegateYield(_asyncGeneratorDelegate(_asyncIterator([values]), _awaitAsyncGenerator), "t0", 1);
...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$slice, x;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _step$value = _toArray(_step.value), _step$value$slice = _toArray(_step$value.slice(0)), x = _step$value$slice.slice(0);

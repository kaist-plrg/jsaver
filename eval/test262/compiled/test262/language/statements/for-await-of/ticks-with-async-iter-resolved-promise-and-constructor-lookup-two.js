...
"pre", // Await
// -> PromiseResolve
"constructor", // Await promise resolved.
"tick 1", // In loop body.
"loop", // Await
// -> PromiseResolve
"constructor", // Await promise resolved
"tick 2", // After exiting loop.
"post"]; // The actual event log.

var actual = []; // Custom async iterator returning the result of the synchronous iterator wrapped in a Promise.
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 4;
            _iterator = _asyncIterator(toAsyncIterator([p]));

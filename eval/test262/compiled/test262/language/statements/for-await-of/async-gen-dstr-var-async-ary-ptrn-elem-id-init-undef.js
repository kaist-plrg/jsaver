  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.delegateYield(_asyncGeneratorDelegate(_asyncIterator([[undefined]]), _awaitAsyncGenerator), "t0", 1);
...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$, x;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _step$value = _slicedToArray(_step.value, 1), _step$value$ = _step$value[0], x = _step$value$ === void 0 ? 23 : _step$value$;

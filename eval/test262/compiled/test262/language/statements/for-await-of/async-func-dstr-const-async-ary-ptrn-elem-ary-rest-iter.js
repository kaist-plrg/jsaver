...
function _fn() {
  _fn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$, _step$value$2, x;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _step$value$ = _step$value$ === void 0 ? function () {
              initCount += 1;
            }() : _step$value$;
            _step$value$2 = _toArray(_step$value$), x = _step$value$2.slice(0);

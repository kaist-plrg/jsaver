  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.delegateYield(_asyncGeneratorDelegate(_asyncIterator([[null, 0, false, '']]), _awaitAsyncGenerator), "t0", 1);
...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$, w, _step$value$2, x, _step$value$3, y, _step$value$4, z;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _step$value = _slicedToArray(_step.value, 4), _step$value$ = _step$value[0], w = _step$value$ === void 0 ? counter() : _step$value$, _step$value$2 = _step$value[1], x = _step$value$2 === void 0 ? counter() : _step$value$2, _step$value$3 = _step$value[2], y = _step$value$3 === void 0 ? counter() : _step$value$3, _step$value$4 = _step$value[3], z = _step$value$4 === void 0 ? counter() : _step$value$4;

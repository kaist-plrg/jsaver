...
function _fn() {
  _fn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$, cover, _step$value$2, xCover;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _step$value = _slicedToArray(_step.value, 2), _step$value$ = _step$value[0], cover = _step$value$ === void 0 ? function () {} : _step$value$, _step$value$2 = _step$value[1], xCover = _step$value$2 === void 0 ? (0, function () {}) : _step$value$2;

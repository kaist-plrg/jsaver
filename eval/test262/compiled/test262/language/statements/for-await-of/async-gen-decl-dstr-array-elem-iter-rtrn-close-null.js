...
function _fn() {
  _fn = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, _step$value$;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            _context.t0 = _step$value$;

          case 16:
            _step$value$ = _context.t0;
...
iter.next().then(function (result) {
  ...
  iter["return"]().then(function () {
    _newArrowCheck(this, _this2);

    return $DONE('Promise incorrectly fulfilled.');

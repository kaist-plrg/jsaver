...
;
var cls = probeBefore();
assert.sameValue(_typeof(cls), 'function');
setBefore();
...
assert.sameValue(_typeof(probeHeritage()), 'function', 'inner binding is immutable');
assert.sameValue(_typeof(cls.prototype.method()), 'function', 'from instance method');
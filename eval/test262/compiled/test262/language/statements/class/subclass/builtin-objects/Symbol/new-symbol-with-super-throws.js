...
features: [Symbol]
---*/
var S1 = /*#__PURE__*/function (_Symbol) {
  _inherits(S1, _Symbol);

  var _super = _createSuper(S1);
  ...
  return _createClass(S1);
}( /*#__PURE__*/_wrapNativeSuper(Symbol));

assert["throws"](TypeError, function () {
  new S1();
});

var S2 = /*#__PURE__*/function (_Symbol2) {
  _inherits(S2, _Symbol2);

  var _super2 = _createSuper(S2);

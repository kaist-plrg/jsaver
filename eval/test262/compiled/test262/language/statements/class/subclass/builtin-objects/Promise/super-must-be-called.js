...
info: |
  ...
  built-in methods.
---*/
var Prom1 = /*#__PURE__*/function (_Promise) {
  _inherits(Prom1, _Promise);

  var _super = _createSuper(Prom1);

  function Prom1() {
    var _this;

    _classCallCheck(this, Prom1);

    return _possibleConstructorReturn(_this);
  }

  return _createClass(Prom1);
...
var Prom2 = /*#__PURE__*/function (_Promise2) {
  _inherits(Prom2, _Promise2);

  var _super2 = _createSuper(Prom2);

  function Prom2(exec) {
    _classCallCheck(this, Prom2);

    return _super2.call(this, exec);
  }

  return _createClass(Prom2);
}( /*#__PURE__*/_wrapNativeSuper(Promise));

...
features: [WeakSet]
---*/
var WS1 = /*#__PURE__*/function (_WeakSet) {
  _inherits(WS1, _WeakSet);

  var _super = _createSuper(WS1);

  function WS1() {
    var _this;

    _classCallCheck(this, WS1);

    return _possibleConstructorReturn(_this);
  }

  return _createClass(WS1);
}( /*#__PURE__*/_wrapNativeSuper(WeakSet));

assert["throws"](ReferenceError, function () {
  new WS1();
});

var WS2 = /*#__PURE__*/function (_WeakSet2) {
  _inherits(WS2, _WeakSet2);

  var _super2 = _createSuper(WS2);

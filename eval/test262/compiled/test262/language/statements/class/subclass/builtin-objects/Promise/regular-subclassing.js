...
info: |
  ...
  built-in methods.
---*/
var Prom = /*#__PURE__*/function (_Promise) {
  _inherits(Prom, _Promise);

  var _super = _createSuper(Prom);

  function Prom() {
    _classCallCheck(this, Prom);

    return _super.apply(this, arguments);
  }

  return _createClass(Prom);
...
assert.sameValue(_typeof(executorArguments[0]), "function");
assert.sameValue(_typeof(executorArguments[1]), "function");
...
---*/
var Base = /*#__PURE__*/_createClass(function Base(x, y) {
...
var Subclass = /*#__PURE__*/function (_Base) {
  ...
  function Subclass(x, y) {
    ...
    assert.sameValue(_assertThisInitialized(_this) !== obj, true, "The result of `this !== obj` is `true`");
    return _this;
  }
...
assert.sameValue(Object.getPrototypeOf(s1), Subclass.prototype, "`Object.getPrototypeOf(s1)` returns `Subclass.prototype`");

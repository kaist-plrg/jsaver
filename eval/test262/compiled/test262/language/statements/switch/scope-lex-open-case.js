...
switch (probeExpr = function probeExpr() {
  return x;
}, null) {
  case (probeSelector = function probeSelector() {
    return _x;
  }, null):
    probeStmt = function probeStmt() {
      return _x;
    };
...
assert.sameValue(probeSelector(), 'inside', 'reference from "selector" Expression');

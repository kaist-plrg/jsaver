...
if (i !== 10) $ERROR('#1: i === 10. Actual:  i ===' + i); //CHECK#2
...
if (j !== 4) $ERROR('#2.2: j === 4. Actual:  j ===' + j); //CHECK#3
...
if (j !== 4) $ERROR('#3.2: j === 4. Actual:  j ===' + j); //CHECK#4
...
if (j !== 9) $ERROR('#4.2: j === 9. Actual:  j ===' + j); //CHECK#5

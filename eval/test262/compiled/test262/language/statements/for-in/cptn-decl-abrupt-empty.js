...
assert.sameValue(eval('4; outer: do { for (var a in { x: 0 }) { continue outer; } } while (false)'), undefined);
assert.sameValue(eval('5; outer: do { for (var b in { x: 0 }) { 6; continue outer; } } while (false)'), 6);
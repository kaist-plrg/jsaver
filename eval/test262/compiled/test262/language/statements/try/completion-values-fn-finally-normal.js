...
assert.sameValue(count["finally"], 1, '1'); // 2: try Abrupt, catch Return, finally Normal; Completion: catch
...
assert.sameValue(count["finally"], 1, '2: fiinally count'); // 3: try Abrupt, catch Abrupt, finally Normal; Completion: catch

...
try {
  ...
  // CHECK#1
  if (e.p1 !== "a") $ERROR('#1: e.p1==="a". Actual:  e.p1===' + e.p1); // CHECK#2

  if (e.value !== 'myObj_value') $ERROR('#2: e.value===\'myObj_value\'. Actual:  e.value===' + e.value); // CHECK#3
...
if (myObj.i !== 6) $ERROR('#4: Handling of catch must be correct'); // CHECK#5

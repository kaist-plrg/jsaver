...
try {
  try {
    ...
    if (er2 !== "ex2") $ERROR('#1.1: Exception === "ex2". Actual:  Exception ===' + e);
    throw "ex1";
  }
} catch (er1) {
...
if (c4 !== 1) $ERROR('#4.5: "finally" block must be evaluated'); // CHECK#5
...
if (c5 !== 1) $ERROR('#5.4: "finally" block must be evaluated'); // CHECK#6
...
if (c6 !== 1) $ERROR('#6.2: "finally" block must be evaluated'); // CHECK#7

...
---*/
var fn,
    count = {}; // 1: try Abrupt, catch Abrupt, finally Abrupt; Completion: finally
...
assert.sameValue(count["finally"], 1, '1: finally count'); // 2: try Abrupt, catch Return, finally Abrupt; Completion: finally
...
assert.sameValue(count["finally"], 1, '2: fiinally count'); // 3: try Return, catch Return, finally Abrupt; Completion: finally

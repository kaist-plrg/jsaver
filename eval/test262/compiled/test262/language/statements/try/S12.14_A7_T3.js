...
if (c2 !== 1) $ERROR('#2.5: "finally" block must be evaluated'); // CHECK#3
...
if (c3 !== 1) $ERROR('#3.4: "finally" block must be evaluated'); // CHECK#4
...
if (c4 !== 4) $ERROR('#4.6: "finally" block must be evaluated'); // CHECK#5
...
if (c5 !== 1) $ERROR('#5.5: "finally" block must be evaluated'); // CHECK#6
...
if (c6 !== 4) $ERROR('#6.2: "finally" block must be evaluated'); // CHECK#7

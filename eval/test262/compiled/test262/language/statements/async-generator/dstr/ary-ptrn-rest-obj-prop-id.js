...
function _f() {
  _f = _wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var _ref2, _ref2$slice, v, w, x, y, z;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref2 = _toArray(_ref), _ref2$slice = _ref2.slice(0), v = _ref2$slice[0], w = _ref2$slice[1], x = _ref2$slice[2], y = _ref2$slice[3], z = _ref2$slice.length;

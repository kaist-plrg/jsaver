...
description: >
    ...
    "var array = [[1,2], [3], []]"
---*/
var array = [[1, 2], [3], []]; //CHECK#1

if (_typeof(array) !== "object") {
  $ERROR('#1: var array = [[1,2], [3], []]; typeof array === "object". Actual: ' + _typeof(array));
} //CHECK#2
...
var subarray = array[0]; //CHECK#5

if (_typeof(subarray) !== "object") {
  $ERROR('#5: var array = [[1,2], [3], []]; var subarray = array[0]; typeof subarray === "object". Actual: ' + _typeof(subarray));
} //CHECK#6
...
var subarray = array[1]; //CHECK#11

if (_typeof(subarray) !== "object") {
  $ERROR('#11: var array = [[1,2], [3], []]; var subarray = array[1]; typeof subarray === "object". Actual: ' + _typeof(subarray));
} //CHECK#12
...
var subarray = array[2]; //CHECK#16

if (_typeof(subarray) !== "object") {
  $ERROR('#16: var array = [[1,2], [3], []]; var subarray = array[2]; typeof subarray === "object". Actual: ' + _typeof(subarray));
} //CHECK#17

...
assert.sameValue(-1n >= '-1', true, 'The result of (-1n >= "-1") is true');
assert.sameValue('-1' >= -1n, true, 'The result of ("-1" >= -1n) is true');
assert.sameValue(9007199254740993n >= '9007199254740992', true, 'The result of (9007199254740993n >= "9007199254740992") is true');
assert.sameValue('9007199254740993' >= 9007199254740992n, true, 'The result of ("9007199254740993" >= 9007199254740992n) is true');
assert.sameValue(-9007199254740992n >= '-9007199254740993', true, 'The result of (-9007199254740992n >= "-9007199254740993") is true');
assert.sameValue('-9007199254740992' >= -9007199254740993n, true, 'The result of ("-9007199254740992" >= -9007199254740993n) is true');
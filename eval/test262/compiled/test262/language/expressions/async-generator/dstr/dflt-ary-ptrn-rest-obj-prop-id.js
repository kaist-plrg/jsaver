    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref2 = _args.length > 0 && _args[0] !== undefined ? _args[0] : [7, 8, 9], _ref3 = _toArray(_ref2), _ref3$slice = _ref3.slice(0), v = _ref3$slice[0], w = _ref3$slice[1], x = _ref3$slice[2], y = _ref3$slice[3], z = _ref3$slice.length;

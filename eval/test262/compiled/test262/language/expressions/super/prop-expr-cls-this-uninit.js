...
var C = /*#__PURE__*/function (_Object) {
  ...
  function C() {
    ...
    try {
      _get((_thisSuper = _assertThisInitialized(_this), _getPrototypeOf(C.prototype)), 'x', _thisSuper);
    } catch (err) {
      caught = err;
    }
...
}( /*#__PURE__*/_wrapNativeSuper(Object)); // When the "construct" invocation completes and the "this" value is

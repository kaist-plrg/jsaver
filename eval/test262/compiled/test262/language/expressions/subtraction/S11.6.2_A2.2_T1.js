...
if ({
  ...
  $ERROR('#1: {valueOf: function() {return 1}} - 1 === 0. Actual: ' + ({
    valueOf: function valueOf() {
      return 1;
    }
  } - 1));
...
if ({
  ...
  $ERROR('#2: {valueOf: function() {return 1}, toString: function() {return 0}} - 1 === 0. Actual: ' + ({
    valueOf: function valueOf() {
      return 1;
    },
    toString: function toString() {
...
if ({
  ...
  $ERROR('#3: {valueOf: function() {return 1}, toString: function() {return {}}} - 1 === 0. Actual: ' + ({
    valueOf: function valueOf() {
      return 1;
    },
    toString: function toString() {
...
try {
  if ({
    ...
    $ERROR('#4.1: {valueOf: function() {return 1}, toString: function() {throw "error"}} - 1 === 0. Actual: ' + ({
      valueOf: function valueOf() {
        return 1;
      },
      toString: function toString() {
...
if (1 - {
  ...
  $ERROR('#5: 1 - {toString: function() {return 1}} === 0. Actual: ' + (1 - {
    toString: function toString() {
      return 1;
    }
  }));
...
if (1 - {
  ...
  $ERROR('#6: 1 - {valueOf: function() {return {}}, toString: function() {return 1}} === 0. Actual: ' + (1 - {
    valueOf: function valueOf() {
      return {};
    },
    toString: function toString() {

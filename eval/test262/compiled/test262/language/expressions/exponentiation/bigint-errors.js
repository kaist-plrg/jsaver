...
assert["throws"](TypeError, function () {
  Math.pow(Symbol('1'), 0n);
}, 'Symbol("1") ** 0n throws TypeError');
assert["throws"](TypeError, function () {
  Math.pow(0n, Symbol('1'));
}, '0n ** Symbol("1") throws TypeError');
assert["throws"](TypeError, function () {
  Math.pow(Object(Symbol('1')), 0n);
}, 'Object(Symbol("1")) ** 0n throws TypeError');
assert["throws"](TypeError, function () {
  Math.pow(0n, Object(Symbol('1')));
}, '0n ** Object(Symbol("1")) throws TypeError');
assert["throws"](TypeError, function () {
  Math.pow(_defineProperty({}, Symbol.toPrimitive, function () {
    return Symbol('1');
  }), 0n);
}, '({[Symbol.toPrimitive]: function() {return Symbol("1");}}) ** 0n throws TypeError');
assert["throws"](TypeError, function () {
  Math.pow(0n, _defineProperty({}, Symbol.toPrimitive, function () {
    return Symbol('1');
  }));

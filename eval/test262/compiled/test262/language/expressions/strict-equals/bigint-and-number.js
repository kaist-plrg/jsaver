...
assert.sameValue(0n === -Number.MIN_VALUE, false, 'The result of (0n === -Number.MIN_VALUE) is false');
assert.sameValue(-Number.MIN_VALUE === 0n, false, 'The result of (-Number.MIN_VALUE === 0n) is false');
assert.sameValue(-10n === Number.MIN_VALUE, false, 'The result of (-10n === Number.MIN_VALUE) is false');
assert.sameValue(Number.MIN_VALUE === -10n, false, 'The result of (Number.MIN_VALUE === -10n) is false');
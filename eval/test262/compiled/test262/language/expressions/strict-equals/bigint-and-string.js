...
assert.sameValue(-1n === '-foo', false, 'The result of (-1n === "-foo") is false');
assert.sameValue('-foo' === -1n, false, 'The result of ("-foo" === -1n) is false');
assert.sameValue(900719925474099101n === '900719925474099101', false, 'The result of (900719925474099101n === "900719925474099101") is false');
assert.sameValue('900719925474099101' === 900719925474099101n, false, 'The result of ("900719925474099101" === 900719925474099101n) is false');
assert.sameValue(900719925474099102n === '900719925474099101', false, 'The result of (900719925474099102n === "900719925474099101") is false');
assert.sameValue('900719925474099101' === 900719925474099102n, false, 'The result of ("900719925474099101" === 900719925474099102n) is false');
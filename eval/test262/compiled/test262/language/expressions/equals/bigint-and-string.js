...
assert.sameValue(-1n == '-foo', false, 'The result of (-1n == "-foo") is false');
assert.sameValue('-foo' == -1n, false, 'The result of ("-foo" == -1n) is false');
assert.sameValue(900719925474099101n == '900719925474099101', true, 'The result of (900719925474099101n == "900719925474099101") is true');
assert.sameValue('900719925474099101' == 900719925474099101n, true, 'The result of ("900719925474099101" == 900719925474099101n) is true');

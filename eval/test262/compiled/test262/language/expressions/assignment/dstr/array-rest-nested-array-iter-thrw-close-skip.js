...
assert["throws"](Test262Error, function () {
  var _iterable, _iterable2, _iterable2$slice;

  0, (_iterable = iterable, _iterable2 = _toArray(_iterable), _iterable2$slice = _toArray(_iterable2.slice(0)), {}[thrower()] = _iterable2$slice.slice(0), _iterable);
});

...
var result;
var vals = [];
result = (_vals = vals, _vals2 = _slicedToArray(_vals, 2), _vals2$ = _vals2[0], xFn = _vals2$ === void 0 ? function x() {} : _vals2$, _vals2$2 = _vals2[1], fn = _vals2$2 === void 0 ? function () {} : _vals2$2, _vals);
assert(xFn.name !== 'xFn');

...
assert.sameValue("".concat(0, " ", plain), '0 [object Object]');
assert.sameValue("".concat(0, " ", plain), '0 [object Object]');
assert.sameValue("".concat(0, " ", plain, "2"), '0 [object Object]2');
assert.sameValue("".concat(0, " ", plain, "2"), '0 [object Object]2');
assert.sameValue("".concat(0, " ", custom), '0 "own" toString');
assert.sameValue("".concat(0, " ", custom), '0 "own" toString');
assert.sameValue("".concat(0, " ", custom, "2"), '0 "own" toString2');
assert.sameValue("".concat(0, " ", custom, "2"), '0 "own" toString2');
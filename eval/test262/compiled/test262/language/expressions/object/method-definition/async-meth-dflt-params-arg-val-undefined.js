...
var __obj = {
  method: function method() {
    ...
    return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var fromLiteral, fromExpr, fromHole;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              fromLiteral = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 23;
              fromExpr = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : 45;
              fromHole = _arguments.length > 2 && _arguments[2] !== undefined ? _arguments[2] : 99;

...
---*/
var o = _defineProperty({}, 1 + 2 - 3 * 4 / Math.pow(5, 6), 2.999232);

assert.sameValue(o[1 + 2 - 3 * 4 / Math.pow(5, 6)], 2.999232);
assert.sameValue(o[String(1 + 2 - 3 * 4 / Math.pow(5, 6))], 2.999232);
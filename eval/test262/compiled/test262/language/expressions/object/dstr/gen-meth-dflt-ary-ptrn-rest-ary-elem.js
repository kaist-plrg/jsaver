    ...
    return regeneratorRuntime.wrap(function method$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : [3, 4, 5], _ref2 = _toArray(_ref), _ref2$slice = _slicedToArray(_ref2.slice(0), 3), x = _ref2$slice[0], y = _ref2$slice[1], z = _ref2$slice[2];

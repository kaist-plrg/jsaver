...
assert.sameValue(x, 0, 'The value of `x` is 0'); //CHECK#3

var
/* y = 1;*/
y;
assert.sameValue(y, undefined, 'The value of `y` is expected to equal `undefined`'); //CHECK#4
...
this.y++;
assert.sameValue(isNaN(y), true, 'isNaN(y) returns true'); //CHECK#7

var string = "/*var y = 0*/";
/* y = 1;*/

assert.sameValue(string, "/*var y = 0*/", 'The value of `string` is "/*var y = 0*/"'); //CHECK#8

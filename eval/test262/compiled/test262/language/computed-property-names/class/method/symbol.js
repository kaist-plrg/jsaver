...
assert(compareArray(Object.getOwnPropertyNames(C.prototype), ['constructor', 'a', 'c']), "`compareArray(Object.getOwnPropertyNames(C.prototype), ['constructor', 'a', 'c'])` returns `true`");
assert(compareArray(Object.getOwnPropertySymbols(C.prototype), [sym1, sym2]), "`compareArray(Object.getOwnPropertySymbols(C.prototype), [sym1, sym2])` returns `true`");
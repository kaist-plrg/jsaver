...
if (_typeof(Object(0)) !== "object") {
  $ERROR('#2: typeof Object(0) === "object". Actual: ' + _typeof(Object(0)));
} // CHECK#3
...
if (_typeof(Object(-0)) !== "object") {
  $ERROR('#5: typeof Object(-0) === "object". Actual: ' + _typeof(Object(-0)));
} // CHECK#6
...
if (_typeof(Object(1)) !== "object") {
  $ERROR('#8: typeof Object(1) === "object". Actual: ' + _typeof(Object(1)));
} // CHECK#9
...
if (_typeof(Object(-1)) !== "object") {
  $ERROR('#11: typeof Object(-1) === "object". Actual: ' + _typeof(Object(-1)));
} // CHECK#12
...
if (_typeof(Object(Number.MIN_VALUE)) !== "object") {
  $ERROR('#14: typeof Object(Number.MIN_VALUE) === "object". Actual: ' + _typeof(Object(Number.MIN_VALUE)));
} // CHECK#15
...
if (_typeof(Object(Number.MAX_VALUE)) !== "object") {
  $ERROR('#17: typeof Object(Number.MAX_VALUE) === "object". Actual: ' + _typeof(Object(Number.MAX_VALUE)));
} // CHECK#18
...
if (_typeof(Object(Number.POSITIVE_INFINITY)) !== "object") {
  $ERROR('#20: typeof Object(Number.POSITIVE_INFINITY) === "object". Actual: ' + _typeof(Object(Number.POSITIVE_INFINITY)));
} // CHECK#21
...
if (_typeof(Object(Number.NEGATIVE_INFINITY)) !== "object") {
  $ERROR('#23: typeof Object(Number.NEGATIVE_INFINITY) === "object". Actual: ' + _typeof(Object(Number.NEGATIVE_INFINITY)));
} // CHECK#24
...
assert.sameValue(Object(NaN).valueOf(), NaN, "Object(NaN).valueOf()"); // CHECK#26

if (_typeof(Object(Number.NaN)) !== "object") {
  $ERROR('#26: typeof Object(Number.NaN) === "object". Actual: ' + _typeof(Object(Number.NaN)));
} // CHECK#27
...
if (_typeof(Object(1.2345)) !== "object") {
  $ERROR('#29: typeof Object(1.2345) === "object". Actual: ' + _typeof(Object(1.2345)));
} // CHECK#30
...
if (_typeof(Object(-1.2345)) !== "object") {
  $ERROR('#32: typeof Object(-1.2345) === "object". Actual: ' + _typeof(Object(-1.2345)));
} // CHECK#33

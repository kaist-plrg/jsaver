...
assert.sameValue(Object.is('foo', 'foo'), true, "`Object.is('foo', 'foo')` returns `true`");
assert.sameValue(Object.is(String('foo'), String('foo')), true, "`Object.is(String('foo'), String('foo'))` returns `true`");
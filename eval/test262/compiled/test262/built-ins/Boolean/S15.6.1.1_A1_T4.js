...
if (typeof Boolean(undefined) !== "boolean") {
  $ERROR('#1.1: typeof Boolean(undefined) should be "boolean", actual is "' + _typeof(Boolean(undefined)) + '"');
}
...
if (typeof Boolean(void 0) !== "boolean") {
  $ERROR('#2.1: typeof Boolean(void 0) should be "boolean", actual is "' + _typeof(Boolean(void 0)) + '"');
}
...
if (typeof Boolean(function () {}()) !== "boolean") {
  $ERROR('#3.1: typeof Boolean(function(){}()) should be "boolean", actual is "' + _typeof(Boolean(function () {}())) + '"');
}
...
if (typeof Boolean(null) !== "boolean") {
  $ERROR('#4.1: typeof Boolean(null) should be "boolean", actual is "' + _typeof(Boolean(null)) + '"');
}
...
if (typeof Boolean(x) !== "boolean") {
  $ERROR('#5.1: var x; typeof Boolean(x) should be "boolean", actual is "' + _typeof(Boolean(x)) + '"');
}

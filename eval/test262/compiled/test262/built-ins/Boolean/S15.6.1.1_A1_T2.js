...
if (typeof Boolean(-Infinity) !== "boolean") {
  $ERROR('#3.1: typeof Boolean(-Infinity) should be "boolean", actual is "' + _typeof(Boolean(-Infinity)) + '"');
}
...
if (typeof Boolean(NaN) !== "boolean") {
  $ERROR('#4.1: typeof Boolean(NaN) should be "boolean", actual is "' + _typeof(Boolean(NaN)) + '"');
}

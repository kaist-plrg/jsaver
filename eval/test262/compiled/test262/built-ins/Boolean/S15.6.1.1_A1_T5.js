...
if (typeof Boolean(x = 0) !== "boolean") {
  $ERROR('#1.1: typeof Boolean(x=0) should be "boolean", actual is "' + _typeof(Boolean(x = 0)) + '"');
}
...
if (typeof Boolean(x = 1) !== "boolean") {
  $ERROR('#2.1: typeof Boolean(x=1) should be "boolean", actual is "' + _typeof(Boolean(x = 1)) + '"');
}
...
if (typeof Boolean(x = false) !== "boolean") {
  $ERROR('#3.1: typeof Boolean(x=false) should be "boolean", actual is "' + _typeof(Boolean(x = false)) + '"');
}
...
if (typeof Boolean(x = true) !== "boolean") {
  $ERROR('#4.1: typeof Boolean(x=true) should be "boolean", actual is "' + _typeof(Boolean(x = true)) + '"');
}
...
if (typeof Boolean(x = null) !== "boolean") {
  $ERROR('#5.1: typeof Boolean(x=null) should be "boolean", actual is "' + _typeof(Boolean(x = null)) + '"');
}

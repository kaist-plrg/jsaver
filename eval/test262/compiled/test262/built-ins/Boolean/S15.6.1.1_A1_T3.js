...
if (typeof Boolean("0") !== "boolean") {
  $ERROR('#1.1: typeof Boolean("0") should be "boolean", actual is "' + _typeof(Boolean("0")) + '"');
}
...
if (typeof Boolean("-1") !== "boolean") {
  $ERROR('#2.1: typeof Boolean("-1") should be "boolean", actual is "' + _typeof(Boolean("-1")) + '"');
}
...
if (typeof Boolean("1") !== "boolean") {
  $ERROR('#3.1: typeof Boolean("1") should be "boolean", actual is "' + _typeof(Boolean("1")) + '"');
}
...
if (typeof Boolean("false") !== "boolean") {
  $ERROR('#4.1: typeof Boolean("false") should be "boolean", actual is "' + _typeof(Boolean("false")) + '"');
}
...
if (typeof Boolean("true") !== "boolean") {
  $ERROR('#5.1: typeof Boolean("true") should be "boolean", actual is "' + _typeof(Boolean("true")) + '"');
}

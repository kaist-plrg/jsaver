...
---*/
// CHECK#1
assert.sameValue(Number("\u180E"), NaN, "Number(\"\\u180E\") === NaN"); // CHECK#2

assert.sameValue(Number("\u180E1234567890\u180E"), NaN, "Number(\"\u180E1234567890\u180E\") === NaN"); // CHECK#3

assert.sameValue(Number("\u180EInfinity\u180E"), NaN, "Number(\"\u180EInfinity\u180E\") === NaN"); // CHECK#4

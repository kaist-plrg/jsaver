...
assert.sameValue(Number(new Number(NaN)), NaN, "Number(new Number(NaN)"); // CHECK#4
...
assert.sameValue(Number(new Number(void 0)), NaN, "Number(new Number(void 0)"); // CHECK#6
...
assert.sameValue(Number(new Array(2, 4, 8, 16, 32)), NaN, "Number(new Array(2,4,8,16,32))"); // CHECK#11
...
assert.sameValue(Number(myobj1), NaN, "Number(myobj1)"); // CHECK#12
...
assert.sameValue(Number(myobj3), NaN, "Number(myobj3)"); // CHECK#14

...
assert.sameValue(Number(dynaString("", "\u180E")), NaN, "Number(dynaString(\"\", \"\u180E\")) === NaN"); // CHECK#2

assert.sameValue(+dynaString("12345", "67890\u180E"), NaN, "+(dynaString(\"12345\", \"67890\u180E\")) === NaN"); // CHECK#3

assert.sameValue(Number(dynaString("Infi", "nity\u180E")), NaN, "Number(dynaString(\"Infi\", \"nity\u180E\")) === NaN"); // CHECK#4

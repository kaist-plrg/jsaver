...
var pairs = [// example from Unicode 5.0, section 3.7, definition D70
["o\u0308", "ö"], // examples from Unicode 5.0, chapter 3.11
["\xE4\u0323", "a\u0323\u0308"], ["a\u0308\u0323", "a\u0323\u0308"], ["\u1EA1\u0308", "a\u0323\u0308"], ["\xE4\u0306", "a\u0308\u0306"], ["\u0103\u0308", "a\u0306\u0308"], // example from Unicode 5.0, chapter 3.12
...
if ("a".localeCompare("Z") < 0) {
  ...
  for (i = 0; i < pairs.length; i++) {
    ...
    if (pair[0].localeCompare(pair[1]) !== 0) {
      $ERROR("String.prototype.localeCompare considers " + pair[0] + " (" + toU(pair[0]) + ") ≠ " + pair[1] + " (" + toU(pair[1]) + ").");
    }
  }
} else {

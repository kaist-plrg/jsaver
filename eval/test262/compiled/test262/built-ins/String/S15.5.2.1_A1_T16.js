...
if (_typeof(__str) !== "object") {
  $ERROR('#1: __str =new String(.12345); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#1.5
...
if (_typeof(__str) !== "object") {
  $ERROR('#3: __str =new  String(.012345); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#2.5
...
if (_typeof(__str) !== "object") {
  $ERROR('#5: __str =new  String(.0012345); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#5.5
...
if (_typeof(__str) !== "object") {
  $ERROR('#7: __str =new  String(.00000012345); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#7.5

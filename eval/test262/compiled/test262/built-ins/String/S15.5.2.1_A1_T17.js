...
if (_typeof(__str) !== "object") {
  $ERROR('#1: __str = new String(1.2345); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#1.5
...
if (_typeof(__str) !== "object") {
  $ERROR('#3: __str = new String(1.234567890); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#3.5
...
if (_typeof(__str) !== "object") {
  $ERROR('#5: __str = new String(1.234500000000000000000000000); typeof __str === "object". Actual: typeof __str ===' + _typeof(__str));
} //
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
//CHECK#5.5

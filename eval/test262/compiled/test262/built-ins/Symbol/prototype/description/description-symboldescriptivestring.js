...
assert.sameValue(symbol.description, 'foo', 'The value of symbol.description is "foo"');
assert.sameValue(symbol.toString(), "Symbol(".concat(symbol.description, ")"), "symbol.toString() returns \"Symbol(".concat(symbol.description, ")\""));
...
assert.sameValue(BigInt.asIntN(_defineProperty({}, Symbol.toPrimitive, function () {
  return 0;
...
assert.sameValue(BigInt.asIntN(Object(NaN), 1n), 0n, "ToIndex: unbox object with internal slot => NaN => 0");
assert.sameValue(BigInt.asIntN(_defineProperty({}, Symbol.toPrimitive, function () {
  return NaN;
...
assert.sameValue(BigInt.asIntN(Object(true), 1n), -1n, "ToIndex: unbox object with internal slot => true => 1");
assert.sameValue(BigInt.asIntN(_defineProperty({}, Symbol.toPrimitive, function () {
  return true;
...
assert.sameValue(BigInt.asIntN(Object("1"), 1n), -1n, "ToIndex: unbox object with internal slot => parse Number");
assert.sameValue(BigInt.asIntN(_defineProperty({}, Symbol.toPrimitive, function () {
  return "1";

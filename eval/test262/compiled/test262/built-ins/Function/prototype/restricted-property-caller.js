...
assert.sameValue(_typeof(descriptor.get), 'function', '%FunctionPrototype%.caller is an accessor property');
assert.sameValue(_typeof(descriptor.set), 'function', '%FunctionPrototype%.caller is an accessor property');

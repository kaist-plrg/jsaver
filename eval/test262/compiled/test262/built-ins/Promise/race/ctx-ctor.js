...
var SubPromise = /*#__PURE__*/function (_Promise) {
  _inherits(SubPromise, _Promise);

  var _super = _createSuper(SubPromise);

  function SubPromise(a) {
    var _this;

    _classCallCheck(this, SubPromise);
  ...
  return _createClass(SubPromise);
...
assert.sameValue(_typeof(executor), 'function');
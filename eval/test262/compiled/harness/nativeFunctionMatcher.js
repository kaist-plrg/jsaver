...
var validateNativeFunctionSource = function validateNativeFunctionSource(source) {
  ...
  var isWhitespace = function isWhitespace(c) {
    ...
    return /[\t\x0B\f \xA0\uFEFF]/.test(c) || UnicodeSpaceSeparator.test(c);
  }.bind(this);

  var pos = 0;

  var eatWhitespace = function eatWhitespace() {
    _newArrowCheck(this, _this);
  ...
  var eatIdentifier = function eatIdentifier() {
    _newArrowCheck(this, _this);
  ...
  var eatString = function eatString() {
    _newArrowCheck(this, _this);
  ...
  }.bind(this); // "Stumble" through source text until matching character is found.
  // Assumes ECMAScript syntax keeps `[]` and `()` balanced.


  var stumbleUntil = function stumbleUntil(c) {
    _newArrowCheck(this, _this);
  ...
  expect('function'); // NativeFunctionAccessor

  eat('get') || eat('set'); // PropertyName
...
var assertToStringOrNativeFunction = function assertToStringOrNativeFunction(fn, expected) {
  var actual = "" + fn;
...
var assertNativeFunction = function assertNativeFunction(fn, special) {
  var actual = "" + fn;

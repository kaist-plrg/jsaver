...
$262.agent.safeBroadcast = function (typedArray) {
  ...
  try {
    ...
    $ERROR("".concat(Constructor.name, " cannot be used as a shared typed array. (").concat(error, ")"));
  }

  $262.agent.broadcast(typedArray.buffer);
};

$262.agent.safeBroadcastAsync = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ta, index, expected) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return $262.agent.broadcast(ta.buffer);

          case 2:
            _context.next = 4;
            return $262.agent.waitUntil(ta, index, expected);

          case 4:
            _context.next = 6;
            return $262.agent.tryYield();
